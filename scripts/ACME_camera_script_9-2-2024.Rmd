...
I've commented out this code so it doesn't run everytime, you can select all the code and hit command + c to uncomment everything 
...
> something weird is happening with the end of one of the LU15 sites
