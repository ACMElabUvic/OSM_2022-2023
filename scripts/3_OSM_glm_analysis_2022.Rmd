...
```{r caribou 3500 summary, eval=FALSE}
...
```{r coyote 4500 summary, eval=FALSE}
...
```{r fisher 2000 summary, eval=FALSE}
...
```{r wolf 4500 summary, eval=FALSE}
...
```{r lynx 1000 summary, eval=FALSE}
...
```{r moose 3750 summary, eval=FALSE}
...
```{r deer 3750 summary, eval=FALSE}
...
```{r select silhouettes, eval=FALSE}
